...
type BucketConfig struct {
	...
	HistoricalTestDataBucket     string   `bson:"historical_test_data_bucket" json:"historical_test_data_bucket" yaml:"historical_test_data_bucket"`
	HistoricalTestDataBucketType PailType `bson:"historical_test_data_bucket_type" json:"historical_test_data_bucket_type" yaml:"historical_test_data_bucket_type"`
}
