...
type CedarConfig struct {
	...
	EvergreenURL string                    `bson:"evergreen_url" json:"evergreen_url" yaml:"evergreen_url"`
...
var (
	...
	cedarConfigurationEvergreenURLKey = bsonutil.MustHaveTag(CedarConfig{}, "EvergreenURL")
